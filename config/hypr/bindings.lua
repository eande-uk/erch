...
o.bind("SUPER + ALT + RETURN", "Tmux", { erch = "terminal-tmux" })
...
o.bind("SUPER + SHIFT + M", "Music", { erch = "or-focus spotify" })
...
-- o.bind("SUPER + SPACE", "erch menu", "erch-menu")

-- Logitech MX Keys examples:
-- o.bind("SUPER + SHIFT + S", nil, "erch-capture-screenshot")
-- o.bind("SUPER + H", nil, "voxtype record toggle")
-- o.bind("SUPER + PERIOD", nil, { erch = "walker -m symbols" })
