if command -v limine &>/dev/null; then
  sudo tee /etc/mkinitcpio.conf.d/erch_hooks.conf <<EOF >/dev/null
...
EOF
  ...
  sudo cp $ERCH_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $ERCH_PATH/default/limine/limine.conf /boot/limine.conf
  ...
  sudo cp $ERCH_PATH/default/snapper/root /etc/snapper/configs/root
