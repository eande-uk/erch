...
ln -snf ~/.config/erch/current/theme/btop.theme ~/.config/btop/themes/current.theme

mkdir -p ~/.config/mako
ln -snf ~/.config/erch/current/theme/mako.ini ~/.config/mako/config
