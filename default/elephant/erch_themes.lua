--
-- Dynamic erch Theme Menu for Elephant/Walker
--
Name = "erchthemes"
NamePretty = "erch Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/erch/themes"
  local erch_path = os.getenv("ERCH_PATH") or ""
  local default_theme_dir = erch_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "erch-theme-set " .. theme_name,
            },
          })
        end
      end
