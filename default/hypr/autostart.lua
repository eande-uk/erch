...
o.exec_on_start("! erch-toggle-enabled waybar-off && " .. o.launch("waybar"))
o.launch_on_start("fcitx5 --disable notificationitem")
o.launch_on_start("swaybg -i ~/.config/erch/current/background -m fill")
o.exec_on_start("/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1")
o.exec_on_start("erch-first-run")
o.exec_on_start("erch-powerprofiles-init")
o.launch_on_start("erch-hyprland-monitor-watch")
...
o.exec_on_start("sleep 2 && erch-hook post-boot")
